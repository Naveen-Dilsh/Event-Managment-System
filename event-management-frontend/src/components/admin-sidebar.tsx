...
const adminNavItems = [
    ...
    { href: "/admin/sponsorships", label: "Sponsorships", icon: Award },
    { href: "/admin/loyalty", label: "Loyalty", icon: Heart },
    { href: "/admin/announcers", label: "Announcers", icon: Mic },
];
        ...
        >
            ...
            <div className="flex h-16 items-center gap-3 border-b border-border/50 px-4">
                ...
                {!collapsed && (
                    <div className="overflow-hidden">
                        <h1 className="truncate text-base font-bold gradient-text">EventFlow</h1>
            ...
            {!collapsed && user && (
                <div className="border-b border-border/50 px-4 py-3">
                    ...
                    <p className="truncate text-xs text-violet-400">{user.role}</p>
                </div>
            )}
